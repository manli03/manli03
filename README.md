...
I'm a final-year Software Engineering student passionate about building practical solutions and exploring innovative technologies. I'm currently seeking an internship placement from **October 6, 2025 to April 10, 2026**.

## 🔧 What I do:
- Building hybrid mobile apps, websites, and backend systems
- Working with modern frameworks, tools, and APIs
- Integrating services like Telegram bots and payment solutions (ToyyibPay)

## 🤖 What I've built:
- Hybrid mobile applications
- Websites and backend integrations
- Automation and basic AI-based projects

## 💡 About me:
I love solving problems, building useful apps, and learning new technologies along the way.
